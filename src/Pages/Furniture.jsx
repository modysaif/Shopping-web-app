...
const Furniture = () => {
 ...
 const {data} = useCustomHook('https://api.escuelajs.co/api/v1/categories/3/products')
  return (
    <>
    <MainImage style={{ backgroundImage: `url(https://wallpaperaccess.com/full/2076113.jpg)` , width:"100%" ,  height:"60vh",backgroundSize:"cover",objectFit:"cover"
}}>
  <Container>
   <ImageDis>
 <ImageTitle>Decorate your Life with Arts Sleep in comfort Sit with luxury</ImageTitle>
